package com.example.weekone_moni.dao;
...
public class ResultsBeanDao extends AbstractDao<ResultsBean, Long> {
    ...
    public static class Properties {
        public final static Property Ddd = new Property(0, Long.class, "ddd", true, "www");
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"RESULTS_BEAN\" (" + //
                "\"www\" INTEGER PRIMARY KEY AUTOINCREMENT ," + // 0: ddd
                "\"_ID\" TEXT," + // 1: _id
    ...
    public ResultsBean readEntity(Cursor cursor, int offset) {
        ResultsBean entity = new ResultsBean( //
            cursor.isNull(offset + 0) ? null : cursor.getLong(offset + 0), // ddd
    ...
    public void readEntity(Cursor cursor, ResultsBean entity, int offset) {
        entity.setDdd(cursor.isNull(offset + 0) ? null : cursor.getLong(offset + 0));
